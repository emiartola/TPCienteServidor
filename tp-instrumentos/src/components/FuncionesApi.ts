...
export function getInstrumentosJSON() {
    let datos: Instrumento[] = [{
        ...
        descripcion: "Estas viendo una excelente mandolina de la marca Stagg, con un sonido muy dulce, tapa aros y fondo de tilo, y diapasón de palisandro. "
            + "Es un instrumento acústico (no se enchufa) de cuerdas dobles (4 pares) con la caja ovalada y cóncava, y el mástil corto. "
            + "Su utilización abarca variados ámbitos, desde rock, folk, country y ensambles experimentales."
    },
    {
        id: 2,
